...
protected:
	virtual void	SetFrameVisibilities( OvrGuiSys & guiSys, ovrFrameInput const & vrFrame, VRMenuObject * self ) const = 0;
...
protected:
	virtual void	SetFrameVisibilities( OvrGuiSys & guiSys, ovrFrameInput const & vrFrame, VRMenuObject * self ) const;
