...
// FIXME:VRAPI remove: simulation code should use ovrApplFrameIn::PredictedDisplayTimeInSeconds
...
eMsgStatus OvrAnimComponent::Frame( OvrGuiSys & guiSys, ovrApplFrameIn const & vrFrame,
...
eMsgStatus OvrAnimComponent::OnEvent_Impl( OvrGuiSys & guiSys, ovrApplFrameIn const & vrFrame,
		VRMenuObject * self, VRMenuEvent const & event )
{
...
void OvrSurfaceAnimComponent::SetFrameVisibilities( OvrGuiSys & guiSys, ovrApplFrameIn const & vrFrame, VRMenuObject * self ) const
{
...
void OvrTrailsAnimComponent::SetFrameVisibilities( OvrGuiSys & guiSys, ovrApplFrameIn const & vrFrame, VRMenuObject * self ) const
{
