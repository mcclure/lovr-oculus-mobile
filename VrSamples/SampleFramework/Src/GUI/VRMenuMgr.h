...
public:
	...
	virtual void				SubmitForRendering( OvrGuiSys & guiSys, OVR::Matrix4f const & centerViewMatrix, 
										menuHandle_t const handle, OVR::Posef const & worldPose, 
	...
	virtual void 				AppendSurfaceList( OVR::Matrix4f const & centerViewMatrix, 
