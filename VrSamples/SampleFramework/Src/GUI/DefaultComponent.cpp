...
eMsgStatus OvrDefaultComponent::OnEvent_Impl( OvrGuiSys & guiSys, ovrApplFrameIn const & vrFrame,
...
eMsgStatus OvrDefaultComponent::Frame( OvrGuiSys & guiSys, ovrApplFrameIn const & vrFrame,
        VRMenuObject * self, VRMenuEvent const & event )
{
...
eMsgStatus OvrDefaultComponent::FocusGained( OvrGuiSys & guiSys, ovrApplFrameIn const & vrFrame,
        VRMenuObject * self, VRMenuEvent const & event )
{
...
eMsgStatus OvrDefaultComponent::FocusLost( OvrGuiSys & guiSys, ovrApplFrameIn const & vrFrame,
        VRMenuObject * self, VRMenuEvent const & event )
{
...
eMsgStatus OvrSurfaceToggleComponent::OnEvent_Impl( OvrGuiSys & guiSys, ovrApplFrameIn const & vrFrame,
	VRMenuObject * self, VRMenuEvent const & event )
{
	switch ( event.EventType )
	{
...
eMsgStatus OvrSurfaceToggleComponent::Frame( OvrGuiSys & guiSys, ovrApplFrameIn const & vrFrame, VRMenuObject * self, VRMenuEvent const & event )
{
