...
public:
	...
	static	void		GetScrollBarParms( OvrGuiSys & guiSys, VRMenu & menu, float scrollBarWidth, const VRMenuId_t parentId, const VRMenuId_t rootId, const VRMenuId_t xformId,
									const VRMenuId_t baseId, const VRMenuId_t thumbId, const OVR::Posef & rootLocalPose, const OVR::Posef & xformPose, const int startElementIndex, 
									const int numElements, const bool verticalBar, const OVR::Vector4f & thumbBorder, std::vector< const VRMenuObjectParms* > & parms );
