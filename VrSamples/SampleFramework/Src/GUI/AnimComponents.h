...
protected:
	virtual void	SetFrameVisibilities( OvrGuiSys & guiSys, ovrApplFrameIn const & vrFrame, VRMenuObject * self ) const = 0;
...
protected:
	virtual void	SetFrameVisibilities( OvrGuiSys & guiSys, ovrApplFrameIn const & vrFrame, VRMenuObject * self ) const;
