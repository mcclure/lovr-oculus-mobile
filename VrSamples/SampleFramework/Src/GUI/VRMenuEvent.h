...
public:
	...
	VRMenuEvent( eVRMenuEventType const eventType, eEventDispatchType const dispatchType, 
            menuHandle_t const & targetHandle, OVR::Vector3f const & floatValue, HitTestResult const & hitResult,
			char const * message )
		: EventType( eventType )
	...
	VRMenuEvent( eVRMenuEventType const eventType, eEventDispatchType const dispatchType,
		menuHandle_t const & targetHandle, menuHandle_t const & otherHandle, OVR::Vector3f const & floatValue, HitTestResult const & hitResult,
		char const * message )
		: EventType( eventType )
		, DispatchType( dispatchType )
		, TargetHandle( targetHandle )
