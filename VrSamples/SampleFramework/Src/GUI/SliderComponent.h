...
public:
	...
	OvrSliderComponent( VRMenu & menu, float const sliderFrac, OVR::Vector3f const & localSlideDelta, 
...
private:
	...
	eMsgStatus			OnInit( OvrGuiSys & guiSys, ovrApplFrameIn const & vrFrame,
								VRMenuObject * self, VRMenuEvent const & event );

	eMsgStatus			OnFrameUpdate( OvrGuiSys & guiSys, ovrApplFrameIn const & vrFrame,
								VRMenuObject * self, VRMenuEvent const & event );
	eMsgStatus			OnTouchDown( OvrGuiSys & guiSys, ovrApplFrameIn const & vrFrame,
								VRMenuObject * self, VRMenuEvent const & event );
	eMsgStatus			OnTouchUp( OvrGuiSys & guiSys, ovrApplFrameIn const & vrFrame,
								VRMenuObject * self, VRMenuEvent const & event );
	eMsgStatus			OnTouchRelative( OvrGuiSys & guiSys, ovrApplFrameIn const & vrFrame,
								VRMenuObject * self, VRMenuEvent const & event );
