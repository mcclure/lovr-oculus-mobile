...
namespace OVRFW
{
	...
	public:
		...
		static UIKeyboard * Create( OvrGuiSys &	GuiSys, UIMenu * menu, const OVR::Vector3f & positionOffset = OVR::Vector3f::ZERO ); //Load the default keyboard set
		static UIKeyboard * Create( OvrGuiSys &	GuiSys, UIMenu * menu, const char * keyboardSet, const OVR::Vector3f & positionOffset = OVR::Vector3f::ZERO );
		static void Free( UIKeyboard * keyboard );

		virtual void SetKeyPressHandler( KeyPressEventT eventHandler, void * userData ) = 0;
		virtual bool OnKeyEvent( const int keyCode, const int repeatCount ) = 0;
