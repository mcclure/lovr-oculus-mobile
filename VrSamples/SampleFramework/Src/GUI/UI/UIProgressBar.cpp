...
void UIProgressBar::AddToMenu( UIMenu *menu, bool showDescriptionLabel, bool showCancelButton, UIObject *parent )
{
	...
	ProgressBarTexture.LoadTextureFromUri( GetGuiSys().GetFileSys(), "apk:///assets/img_progressbar_foreground.png" );
	ProgressBarBackgroundTexture.LoadTextureFromUri( GetGuiSys().GetFileSys(), "apk:///assets/img_progressbar_background.png" );
	...
	if ( showCancelButton )
	{
		CancelButtonTexture.LoadTextureFromUri( GetGuiSys().GetFileSys(), "apk:///assets/img_btn_download_cancel.png" );
