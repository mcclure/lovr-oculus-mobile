...
eMsgStatus UIButtonComponent::OnEvent_Impl( OvrGuiSys & guiSys, ovrApplFrameIn const & vrFrame,
...
eMsgStatus UIButtonComponent::FocusGained( OvrGuiSys & guiSys, ovrApplFrameIn const & vrFrame,
        VRMenuObject * self, VRMenuEvent const & event )
{
	if ( Button == nullptr ) 
	{
...
eMsgStatus UIButtonComponent::FocusLost( OvrGuiSys & guiSys, ovrApplFrameIn const & vrFrame,
        VRMenuObject * self, VRMenuEvent const & event )
{
	if ( Button == nullptr ) 
	{
