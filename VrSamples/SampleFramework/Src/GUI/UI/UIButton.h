...
private:
    ...
    eMsgStatus              FocusGained( OvrGuiSys & guiSys, ovrApplFrameIn const & vrFrame,
                                    VRMenuObject * self, VRMenuEvent const & event );
    eMsgStatus              FocusLost( OvrGuiSys & guiSys, ovrApplFrameIn const & vrFrame,
                                    VRMenuObject * self, VRMenuEvent const & event );
};
...
public:
	...
	void								SetButtonColors( const OVR::Vector4f &normal, const OVR::Vector4f &hover, const OVR::Vector4f &pressed );
	...
	void								SetAsToggleButton( const UITexture & pressedHoverTexture, const OVR::Vector4f & pressedHoverColor );
