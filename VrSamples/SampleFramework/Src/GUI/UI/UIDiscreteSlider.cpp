...
void UIDiscreteSliderComponent::SetCurrentValue( unsigned int value )
{
	...
	{
		ALOGW( "UIDiscreteSliderComponent::SetCurrentValue - %d outside range %d -> %zu", value, 0, Cells.size() );
	}
}
...
eMsgStatus UIDiscreteSliderComponent::OnEvent_Impl( OvrGuiSys & guiSys, ovrApplFrameIn const & vrFrame, VRMenuObject * self, VRMenuEvent const & event )
{
...
eMsgStatus UICellComponent::OnEvent_Impl( OvrGuiSys & guiSys, ovrApplFrameIn const & vrFrame, VRMenuObject * self, VRMenuEvent const & event )
{
