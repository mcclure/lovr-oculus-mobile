...
void UINotification::AddToMenu( UIMenu *menu, const char* iconTextureName,  const char* backgroundTintTextureName, UIObject *parent )
{
	...
	//textures
	IconTexture.LoadTextureFromUri( GuiSys.GetFileSys(), (std::string("apk:///") + iconTextureName).c_str() );
	BackgroundTintTexture.LoadTextureFromUri( GuiSys.GetFileSys(), (std::string("apk:///") + backgroundTintTextureName).c_str() );
...
eMsgStatus UINotificationComponent::OnEvent_Impl( OvrGuiSys & guiSys, ovrApplFrameIn const & vrFrame,
...
eMsgStatus UINotificationComponent::Frame( OvrGuiSys & guiSys, ovrApplFrameIn const & vrFrame,
                                    VRMenuObject * self, VRMenuEvent const & event )
{
