...
eMsgStatus OvrTextFade_Component::OnEvent_Impl( OvrGuiSys & guiSys, ovrApplFrameIn const & vrFrame,
...
eMsgStatus OvrTextFade_Component::Frame( OvrGuiSys & guiSys, ovrApplFrameIn const & vrFrame,
											VRMenuObject * self, VRMenuEvent const & event )
{
...
eMsgStatus OvrTextFade_Component::FocusGained( OvrGuiSys & guiSys, ovrApplFrameIn const & vrFrame,
												VRMenuObject * self, VRMenuEvent const & event )
{
...
eMsgStatus OvrTextFade_Component::FocusLost( OvrGuiSys & guiSys, ovrApplFrameIn const & vrFrame,
												VRMenuObject * self, VRMenuEvent const & event )
{
