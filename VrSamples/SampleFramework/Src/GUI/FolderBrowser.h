...
private:
	...
	void				DisplaceFolder( int index, const OVR::Vector3f & direction, float distance, bool startOffSelf = false );
	...
	OVR::Vector3f 						TouchDownPosistion; // First event in touch relative is considered as touch down position
