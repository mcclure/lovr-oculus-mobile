...
public:
	...
	OVR::Matrix4f						GetLocalTransform() const { return localTransform; }
	OVR::Matrix4f						GetGlobalTransform() const { return globalTransform; }
...
public:
	...
	OVR::Matrix4f					GetMatrix() const { return modelMatrix;  } 
