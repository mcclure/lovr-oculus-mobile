...
public:
	...
	void					Frame(	const ovrApplFrameIn & vrFrame,
	...
	const OVR::Vector3f &	GetFootPos() const { return FootPos; }
	...
	OVR::Matrix4f 			GetEyeProjectionMatrix( const int eye, const float fovDegreesX, const float fovDegreesY ) const;
	OVR::Matrix4f 			GetEyeViewProjectionMatrix( const int eye, const float fovDegreesX, const float fovDegreesY ) const;
