...
ModelGlPrograms OvrSceneView::GetDefaultGLPrograms()
{
	...
	if ( !LoadedPrograms )
	{
		ProgVertexColor	= OVRFW::GlProgram::Build( VertexColorVertexShaderSrc, VertexColorFragmentShaderSrc, nullptr, 0 );

		{
			...
			ProgSingleTexture = OVRFW::GlProgram::Build( SingleTextureVertexShaderSrc, SingleTextureFragmentShaderSrc, uniformParms, uniformCount );
		}

		{
			...
			const int uniformCount = sizeof(uniformParms) / sizeof(OVRFW::ovrProgramParm);
			ProgLightMapped	= OVRFW::GlProgram::Build( LightMappedVertexShaderSrc, LightMappedFragmentShaderSrc, uniformParms, uniformCount );
		}

		{
			...
			const int uniformCount = sizeof(uniformParms) / sizeof(OVRFW::ovrProgramParm);
			ProgReflectionMapped = OVRFW::GlProgram::Build( ReflectionMappedVertexShaderSrc, ReflectionMappedFragmentShaderSrc, uniformParms, uniformCount );
		}

		{
			...
			const int uniformCount = sizeof(uniformParms) / sizeof(OVRFW::ovrProgramParm);
			ProgSimplePBR = OVRFW::GlProgram::Build( SimplePBRVertexShaderSrc, SimplePBRFragmentShaderSrc, uniformParms, uniformCount );
		}

		{
			...
			const int uniformCount = sizeof(uniformParms) / sizeof(OVRFW::ovrProgramParm);
			ProgBaseColorPBR = OVRFW::GlProgram::Build( SimplePBRVertexShaderSrc, BaseColorPBRFragmentShaderSrc, uniformParms, uniformCount );
		}

		{
			...
			const int uniformCount = sizeof(uniformParms) / sizeof(OVRFW::ovrProgramParm);
			ProgBaseColorEmissivePBR = OVRFW::GlProgram::Build( SimplePBRVertexShaderSrc, BaseColorEmissivePBRFragmentShaderSrc, uniformParms, uniformCount );
		}

		{
			...
			const int uniformCount = sizeof(uniformParms) / sizeof(OVRFW::ovrProgramParm);
			ProgSkinnedVertexColor = OVRFW::GlProgram::Build( VertexColorSkinned1VertexShaderSrc, VertexColorFragmentShaderSrc, uniformParms, uniformCount );
		}

		{
			...
			const int uniformCount = sizeof(uniformParms) / sizeof(OVRFW::ovrProgramParm);
			ProgSkinnedSingleTexture = OVRFW::GlProgram::Build( SingleTextureSkinned1VertexShaderSrc, SingleTextureFragmentShaderSrc, uniformParms, uniformCount );
		}

		{
			...
			const int uniformCount = sizeof(uniformParms) / sizeof(OVRFW::ovrProgramParm);
			ProgSkinnedLightMapped	= OVRFW::GlProgram::Build( LightMappedSkinned1VertexShaderSrc, LightMappedFragmentShaderSrc, uniformParms, uniformCount );
		}

		{
			...
			const int uniformCount = sizeof(uniformParms) / sizeof(OVRFW::ovrProgramParm);
			ProgSkinnedReflectionMapped	= OVRFW::GlProgram::Build( ReflectionMappedSkinned1VertexShaderSrc, ReflectionMappedFragmentShaderSrc, uniformParms, uniformCount );
		}

		{
			...
			const int uniformCount = sizeof(uniformParms) / sizeof(OVRFW::ovrProgramParm);
			ProgSkinnedSimplePBR = OVRFW::GlProgram::Build( SimplePBRSkinned1VertexShaderSrc, SimplePBRFragmentShaderSrc, uniformParms, uniformCount );
		}

		{
			...
			const int uniformCount = sizeof(uniformParms) / sizeof(OVRFW::ovrProgramParm);
			ProgSkinnedBaseColorPBR	= OVRFW::GlProgram::Build( SimplePBRSkinned1VertexShaderSrc, BaseColorPBRFragmentShaderSrc, uniformParms, uniformCount );
		}

		{
			...
			const int uniformCount = sizeof(uniformParms) / sizeof(OVRFW::ovrProgramParm);
			ProgSkinnedBaseColorEmissivePBR = OVRFW::GlProgram::Build( SimplePBRSkinned1VertexShaderSrc, BaseColorEmissivePBRFragmentShaderSrc, uniformParms, uniformCount );
		}
