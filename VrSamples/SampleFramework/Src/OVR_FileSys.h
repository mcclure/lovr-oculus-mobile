...
public:
	...
	static void 			PushBackSearchPathIfValid( ovrJava const & java, ovrStorageType toStorage, ovrFolderType toFolder, const char * subfolder, std::vector<std::string> & searchPaths );
	static bool 			GetPathIfValidPermission( ovrJava const & java, ovrStorageType toStorage, ovrFolderType toFolder, const char * subfolder, permissionFlags_t permission, std::string & outPath );
};
...
inline bool GetFullPath( const std::vector<std::string>& searchPaths, char const * relativePath, char * outPath, const int outMaxLen )
{
...
inline bool GetFullPath( const std::vector<std::string>& searchPaths, char const * relativePath, std::string & outPath )
{
	char largePath[1024];
...
inline bool ToRelativePath( const std::vector<std::string>& searchPaths, char const * fullPath, char * outPath, const int outMaxLen )
{
...
inline bool ToRelativePath( const std::vector<std::string>& searchPaths, char const * fullPath, std::string & outPath )
{
	char largePath[1024];
