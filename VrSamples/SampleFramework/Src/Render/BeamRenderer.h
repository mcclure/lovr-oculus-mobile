...
public:
	...
	void		    RenderEyeView( const OVR::Matrix4f & viewMatrix, const OVR::Matrix4f & projMatrix, 
	...
	handle_t	  	AddBeam( const OVRFW::ovrApplFrameIn & frame, const ovrTextureAtlas & atlas,
							const int atlasIndex, const float width,
							const OVR::Vector3f & start, const OVR::Vector3f & end, 
