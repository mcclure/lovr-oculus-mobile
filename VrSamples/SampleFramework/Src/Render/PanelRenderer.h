...
public:
	...
	void			SetPose( const OVR::Posef & pose ) { ModelMatrix = OVR::Matrix4f( pose ) * OVR::Matrix4f::Scaling(ModelScale); }
	void			SetScale( OVR::Vector3f v ) { ModelScale = v; }
	void			SetChannelColor( int channel, OVR::Vector4f c ) { UniformChannelColor[ channel % 4] = c; }
