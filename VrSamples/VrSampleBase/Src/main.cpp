...
public:
	...
	ovrSampleAppl(  const int32_t mainThreadTid, const int32_t renderThreadTid,
...
{
	std::unique_ptr< ovrSampleAppl > appl = std::unique_ptr< ovrSampleAppl >( new ovrSampleAppl( 0, 0, 0, 0 ) );
	appl->Run( app );
}
