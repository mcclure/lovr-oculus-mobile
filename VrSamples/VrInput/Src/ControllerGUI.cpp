...
void ovrControllerGUI::OnItemEvent_Impl( OvrGuiSys &guiSys, ovrApplFrameIn const &vrFrame,
		VRMenuId_t const itemId, VRMenuEvent const &event ) 
{
}

bool ovrControllerGUI::OnKeyEvent_Impl( OvrGuiSys &guiSys, int const keyCode, const int repeatCount ) 
{
