...
private:
	...
	virtual void OnItemEvent_Impl( OvrGuiSys &guiSys, ovrApplFrameIn const &vrFrame,
								   VRMenuId_t const itemId, VRMenuEvent const &event ) override;

	virtual bool OnKeyEvent_Impl( OvrGuiSys &guiSys, int const keyCode, const int repeatCount ) override;
