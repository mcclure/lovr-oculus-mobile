...
bool ovrVkInstance_Create( ovrVkInstance * instance, const char * requiredExtensionNames, uint32_t requiredExtensionNamesSize );
...
// Expects 'requiredExtensionNames' as list of strings delimited by a single space.
bool ovrVkDevice_SelectPhysicalDevice( ovrVkDevice * device, ovrVkInstance * instance,
		const char * requiredExtensionNames, uint32_t requiredExtensionNamesSize );
...
void ovrVkDepthBuffer_Create( ovrVkContext * context, ovrVkDepthBuffer * depthBuffer,
									const ovrSurfaceDepthFormat depthFormat, const ovrSampleCount sampleCount,
...
typedef enum
{
	...
	OVR_TEXTURE_FORMAT_R8G8B8A8_UNORM		= VK_FORMAT_R8G8B8A8_UNORM,				// 4-component, 8-bit unsigned normalized
	...
	OVR_TEXTURE_FORMAT_R8G8B8A8_SNORM		= VK_FORMAT_R8G8B8A8_SNORM,				// 4-component, 8-bit signed normalized
	...
	OVR_TEXTURE_FORMAT_R8G8B8A8_UINT		= VK_FORMAT_R8G8B8A8_UINT,				// 4-component, 8-bit unsigned integer
	...
	OVR_TEXTURE_FORMAT_R16G16_UNORM			= VK_FORMAT_R16G16_UNORM,				// 2-component, 16-bit unsigned normalized
	OVR_TEXTURE_FORMAT_R16G16B16A16_UNORM	= VK_FORMAT_R16G16B16A16_UNORM,			// 4-component, 16-bit unsigned normalized

	OVR_TEXTURE_FORMAT_R16_SNORM			= VK_FORMAT_R16_SNORM,					// 1-component, 16-bit signed normalized
	OVR_TEXTURE_FORMAT_R16G16_SNORM			= VK_FORMAT_R16G16_SNORM,				// 2-component, 16-bit signed normalized
	OVR_TEXTURE_FORMAT_R16G16B16A16_SNORM	= VK_FORMAT_R16G16B16A16_SNORM,			// 4-component, 16-bit signed normalized
	...
	OVR_TEXTURE_FORMAT_R16G16B16A16_UINT	= VK_FORMAT_R16G16B16A16_UINT,			// 4-component, 16-bit unsigned integer
	...
	OVR_TEXTURE_FORMAT_R16G16B16A16_SINT	= VK_FORMAT_R16G16B16A16_SINT,			// 4-component, 16-bit signed integer

	OVR_TEXTURE_FORMAT_R16_SFLOAT			= VK_FORMAT_R16_SFLOAT,					// 1-component, 16-bit floating-point
	OVR_TEXTURE_FORMAT_R16G16_SFLOAT		= VK_FORMAT_R16G16_SFLOAT,				// 2-component, 16-bit floating-point
	OVR_TEXTURE_FORMAT_R16G16B16A16_SFLOAT	= VK_FORMAT_R16G16B16A16_SFLOAT,		// 4-component, 16-bit floating-point
	...
	OVR_TEXTURE_FORMAT_R32G32B32A32_UINT	= VK_FORMAT_R32G32B32A32_UINT,			// 4-component, 32-bit unsigned integer
	...
	OVR_TEXTURE_FORMAT_R32G32B32A32_SINT	= VK_FORMAT_R32G32B32A32_SINT,			// 4-component, 32-bit signed integer

	OVR_TEXTURE_FORMAT_R32_SFLOAT			= VK_FORMAT_R32_SFLOAT,					// 1-component, 32-bit floating-point
	OVR_TEXTURE_FORMAT_R32G32_SFLOAT		= VK_FORMAT_R32G32_SFLOAT,				// 2-component, 32-bit floating-point
	OVR_TEXTURE_FORMAT_R32G32B32A32_SFLOAT	= VK_FORMAT_R32G32B32A32_SFLOAT,		// 4-component, 32-bit floating-point

	//
	// S3TC/DXT/BC
	//
	OVR_TEXTURE_FORMAT_BC1_R8G8B8_UNORM		= VK_FORMAT_BC1_RGB_UNORM_BLOCK,		// 3-component, line through 3D space, unsigned normalized
	OVR_TEXTURE_FORMAT_BC1_R8G8B8A1_UNORM	= VK_FORMAT_BC1_RGBA_UNORM_BLOCK,		// 4-component, line through 3D space plus 1-bit alpha, unsigned normalized
	OVR_TEXTURE_FORMAT_BC2_R8G8B8A8_UNORM	= VK_FORMAT_BC2_UNORM_BLOCK,			// 4-component, line through 3D space plus line through 1D space, unsigned normalized
	OVR_TEXTURE_FORMAT_BC3_R8G8B8A4_UNORM	= VK_FORMAT_BC3_UNORM_BLOCK,			// 4-component, line through 3D space plus 4-bit alpha, unsigned normalized

	OVR_TEXTURE_FORMAT_BC1_R8G8B8_SRGB		= VK_FORMAT_BC1_RGB_SRGB_BLOCK,			// 3-component, line through 3D space, sRGB
	OVR_TEXTURE_FORMAT_BC1_R8G8B8A1_SRGB	= VK_FORMAT_BC1_RGBA_SRGB_BLOCK,		// 4-component, line through 3D space plus 1-bit alpha, sRGB
	OVR_TEXTURE_FORMAT_BC2_R8G8B8A8_SRGB	= VK_FORMAT_BC2_SRGB_BLOCK,				// 4-component, line through 3D space plus line through 1D space, sRGB
	OVR_TEXTURE_FORMAT_BC3_R8G8B8A4_SRGB	= VK_FORMAT_BC3_SRGB_BLOCK,				// 4-component, line through 3D space plus 4-bit alpha, sRGB
    
	OVR_TEXTURE_FORMAT_BC4_R8_UNORM			= VK_FORMAT_BC4_UNORM_BLOCK,			// 1-component, line through 1D space, unsigned normalized
	OVR_TEXTURE_FORMAT_BC5_R8G8_UNORM		= VK_FORMAT_BC5_UNORM_BLOCK,			// 2-component, two lines through 1D space, unsigned normalized

	OVR_TEXTURE_FORMAT_BC4_R8_SNORM			= VK_FORMAT_BC4_SNORM_BLOCK,			// 1-component, line through 1D space, signed normalized
	OVR_TEXTURE_FORMAT_BC5_R8G8_SNORM		= VK_FORMAT_BC5_SNORM_BLOCK,			// 2-component, two lines through 1D space, signed normalized

	//
	// ETC
	//
	OVR_TEXTURE_FORMAT_ETC2_R8G8B8_UNORM	= VK_FORMAT_ETC2_R8G8B8_UNORM_BLOCK,	// 3-component ETC2, unsigned normalized
	OVR_TEXTURE_FORMAT_ETC2_R8G8B8A1_UNORM	= VK_FORMAT_ETC2_R8G8B8A1_UNORM_BLOCK,	// 3-component with 1-bit alpha ETC2, unsigned normalized
	OVR_TEXTURE_FORMAT_ETC2_R8G8B8A8_UNORM	= VK_FORMAT_ETC2_R8G8B8A8_UNORM_BLOCK,	// 4-component ETC2, unsigned normalized

	OVR_TEXTURE_FORMAT_ETC2_R8G8B8_SRGB		= VK_FORMAT_ETC2_R8G8B8_SRGB_BLOCK,		// 3-component ETC2, sRGB
	OVR_TEXTURE_FORMAT_ETC2_R8G8B8A1_SRGB	= VK_FORMAT_ETC2_R8G8B8A1_SRGB_BLOCK,	// 3-component with 1-bit alpha ETC2, sRGB
	OVR_TEXTURE_FORMAT_ETC2_R8G8B8A8_SRGB	= VK_FORMAT_ETC2_R8G8B8A8_SRGB_BLOCK,	// 4-component ETC2, sRGB

	OVR_TEXTURE_FORMAT_EAC_R11_UNORM		= VK_FORMAT_EAC_R11_UNORM_BLOCK,		// 1-component ETC, line through 1D space, unsigned normalized
	OVR_TEXTURE_FORMAT_EAC_R11G11_UNORM		= VK_FORMAT_EAC_R11G11_UNORM_BLOCK,		// 2-component ETC, two lines through 1D space, unsigned normalized

	OVR_TEXTURE_FORMAT_EAC_R11_SNORM		= VK_FORMAT_EAC_R11_SNORM_BLOCK,		// 1-component ETC, line through 1D space, signed normalized
	OVR_TEXTURE_FORMAT_EAC_R11G11_SNORM		= VK_FORMAT_EAC_R11G11_SNORM_BLOCK,		// 2-component ETC, two lines through 1D space, signed normalized

	//
	// ASTC
	//
	OVR_TEXTURE_FORMAT_ASTC_4x4_UNORM		= VK_FORMAT_ASTC_4x4_UNORM_BLOCK,		// 4-component ASTC, 4x4 blocks, unsigned normalized
	OVR_TEXTURE_FORMAT_ASTC_5x4_UNORM		= VK_FORMAT_ASTC_5x4_UNORM_BLOCK,		// 4-component ASTC, 5x4 blocks, unsigned normalized
	OVR_TEXTURE_FORMAT_ASTC_5x5_UNORM		= VK_FORMAT_ASTC_5x5_UNORM_BLOCK,		// 4-component ASTC, 5x5 blocks, unsigned normalized
	OVR_TEXTURE_FORMAT_ASTC_6x5_UNORM		= VK_FORMAT_ASTC_6x5_UNORM_BLOCK,		// 4-component ASTC, 6x5 blocks, unsigned normalized
	OVR_TEXTURE_FORMAT_ASTC_6x6_UNORM		= VK_FORMAT_ASTC_6x6_UNORM_BLOCK,		// 4-component ASTC, 6x6 blocks, unsigned normalized
	OVR_TEXTURE_FORMAT_ASTC_8x5_UNORM		= VK_FORMAT_ASTC_8x5_UNORM_BLOCK,		// 4-component ASTC, 8x5 blocks, unsigned normalized
	OVR_TEXTURE_FORMAT_ASTC_8x6_UNORM		= VK_FORMAT_ASTC_8x6_UNORM_BLOCK,		// 4-component ASTC, 8x6 blocks, unsigned normalized
	OVR_TEXTURE_FORMAT_ASTC_8x8_UNORM		= VK_FORMAT_ASTC_8x8_UNORM_BLOCK,		// 4-component ASTC, 8x8 blocks, unsigned normalized
	OVR_TEXTURE_FORMAT_ASTC_10x5_UNORM		= VK_FORMAT_ASTC_10x5_UNORM_BLOCK,		// 4-component ASTC, 10x5 blocks, unsigned normalized
	OVR_TEXTURE_FORMAT_ASTC_10x6_UNORM		= VK_FORMAT_ASTC_10x6_UNORM_BLOCK,		// 4-component ASTC, 10x6 blocks, unsigned normalized
	OVR_TEXTURE_FORMAT_ASTC_10x8_UNORM		= VK_FORMAT_ASTC_10x8_UNORM_BLOCK,		// 4-component ASTC, 10x8 blocks, unsigned normalized
	OVR_TEXTURE_FORMAT_ASTC_10x10_UNORM		= VK_FORMAT_ASTC_10x10_UNORM_BLOCK,		// 4-component ASTC, 10x10 blocks, unsigned normalized
	OVR_TEXTURE_FORMAT_ASTC_12x10_UNORM		= VK_FORMAT_ASTC_12x10_UNORM_BLOCK,		// 4-component ASTC, 12x10 blocks, unsigned normalized
	OVR_TEXTURE_FORMAT_ASTC_12x12_UNORM		= VK_FORMAT_ASTC_12x12_UNORM_BLOCK,		// 4-component ASTC, 12x12 blocks, unsigned normalized

	OVR_TEXTURE_FORMAT_ASTC_4x4_SRGB		= VK_FORMAT_ASTC_4x4_SRGB_BLOCK,		// 4-component ASTC, 4x4 blocks, sRGB
	OVR_TEXTURE_FORMAT_ASTC_5x4_SRGB		= VK_FORMAT_ASTC_5x4_SRGB_BLOCK,		// 4-component ASTC, 5x4 blocks, sRGB
	OVR_TEXTURE_FORMAT_ASTC_5x5_SRGB		= VK_FORMAT_ASTC_5x5_SRGB_BLOCK,		// 4-component ASTC, 5x5 blocks, sRGB
	OVR_TEXTURE_FORMAT_ASTC_6x5_SRGB		= VK_FORMAT_ASTC_6x5_SRGB_BLOCK,		// 4-component ASTC, 6x5 blocks, sRGB
	OVR_TEXTURE_FORMAT_ASTC_6x6_SRGB		= VK_FORMAT_ASTC_6x6_SRGB_BLOCK,		// 4-component ASTC, 6x6 blocks, sRGB
	OVR_TEXTURE_FORMAT_ASTC_8x5_SRGB		= VK_FORMAT_ASTC_8x5_SRGB_BLOCK,		// 4-component ASTC, 8x5 blocks, sRGB
	OVR_TEXTURE_FORMAT_ASTC_8x6_SRGB		= VK_FORMAT_ASTC_8x6_SRGB_BLOCK,		// 4-component ASTC, 8x6 blocks, sRGB
	OVR_TEXTURE_FORMAT_ASTC_8x8_SRGB		= VK_FORMAT_ASTC_8x8_SRGB_BLOCK,		// 4-component ASTC, 8x8 blocks, sRGB
	OVR_TEXTURE_FORMAT_ASTC_10x5_SRGB		= VK_FORMAT_ASTC_10x5_SRGB_BLOCK,		// 4-component ASTC, 10x5 blocks, sRGB
	OVR_TEXTURE_FORMAT_ASTC_10x6_SRGB		= VK_FORMAT_ASTC_10x6_SRGB_BLOCK,		// 4-component ASTC, 10x6 blocks, sRGB
	OVR_TEXTURE_FORMAT_ASTC_10x8_SRGB		= VK_FORMAT_ASTC_10x8_SRGB_BLOCK,		// 4-component ASTC, 10x8 blocks, sRGB
	OVR_TEXTURE_FORMAT_ASTC_10x10_SRGB		= VK_FORMAT_ASTC_10x10_SRGB_BLOCK,		// 4-component ASTC, 10x10 blocks, sRGB
	OVR_TEXTURE_FORMAT_ASTC_12x10_SRGB		= VK_FORMAT_ASTC_12x10_SRGB_BLOCK,		// 4-component ASTC, 12x10 blocks, sRGB
	OVR_TEXTURE_FORMAT_ASTC_12x12_SRGB		= VK_FORMAT_ASTC_12x12_SRGB_BLOCK,		// 4-component ASTC, 12x12 blocks, sRGB
} ovrVkTextureFormat;
...
void ovrVkTexture_ChangeUsage( ovrVkContext * context, VkCommandBuffer cmdBuffer, ovrVkTexture * texture, const ovrVkTextureUsage usage );
...
void ovrVkTriangleIndexArray_Alloc( ovrVkTriangleIndexArray * indices, const int indexCount, const unsigned short * data );

void ovrVkTriangleIndexArray_Free( ovrVkTriangleIndexArray * indices );

void ovrVkVertexAttributeArrays_Map( ovrVkVertexAttributeArrays * attribs, void * data, const size_t dataSize, const int vertexCount, const int attribsFlags );

void ovrVkVertexAttributeArrays_Alloc( ovrVkVertexAttributeArrays * attribs, const ovrVkVertexAttribute * layout, const int vertexCount, const int attribsFlags );
...
typedef enum
{
	...
	OVR_VERTEX_ATTRIBUTE_FLAG_TRANSFORM		= 1 << 10		// mat4 vertexTransform (NOTE this mat4 takes up 4 attribute locations)
...
{
	{ OVR_VERTEX_ATTRIBUTE_FLAG_POSITION,		OFFSETOF_MEMBER( ovrDefaultVertexAttributeArrays, position ),		SIZEOF_MEMBER( ovrDefaultVertexAttributeArrays, position[0] ),		VK_FORMAT_R32G32B32_SFLOAT,		1,	"vertexPosition" },
	{ OVR_VERTEX_ATTRIBUTE_FLAG_NORMAL,			OFFSETOF_MEMBER( ovrDefaultVertexAttributeArrays, normal ),			SIZEOF_MEMBER( ovrDefaultVertexAttributeArrays, normal[0] ),		VK_FORMAT_R32G32B32_SFLOAT,		1,	"vertexNormal" },
	{ OVR_VERTEX_ATTRIBUTE_FLAG_TANGENT,		OFFSETOF_MEMBER( ovrDefaultVertexAttributeArrays, tangent ),		SIZEOF_MEMBER( ovrDefaultVertexAttributeArrays, tangent[0] ),		VK_FORMAT_R32G32B32_SFLOAT,		1,	"vertexTangent" },
	{ OVR_VERTEX_ATTRIBUTE_FLAG_BINORMAL,		OFFSETOF_MEMBER( ovrDefaultVertexAttributeArrays, binormal ),		SIZEOF_MEMBER( ovrDefaultVertexAttributeArrays, binormal[0] ),		VK_FORMAT_R32G32B32_SFLOAT,		1,	"vertexBinormal" },
	{ OVR_VERTEX_ATTRIBUTE_FLAG_COLOR,			OFFSETOF_MEMBER( ovrDefaultVertexAttributeArrays, color ),			SIZEOF_MEMBER( ovrDefaultVertexAttributeArrays, color[0] ),			VK_FORMAT_R32G32B32A32_SFLOAT,	1,	"vertexColor" },
	{ OVR_VERTEX_ATTRIBUTE_FLAG_UV0,			OFFSETOF_MEMBER( ovrDefaultVertexAttributeArrays, uv0 ),			SIZEOF_MEMBER( ovrDefaultVertexAttributeArrays, uv0[0] ),			VK_FORMAT_R32G32_SFLOAT,		1,	"vertexUv0" },
	{ OVR_VERTEX_ATTRIBUTE_FLAG_UV1,			OFFSETOF_MEMBER( ovrDefaultVertexAttributeArrays, uv1 ),			SIZEOF_MEMBER( ovrDefaultVertexAttributeArrays, uv1[0] ),			VK_FORMAT_R32G32_SFLOAT,		1,	"vertexUv1" },
	{ OVR_VERTEX_ATTRIBUTE_FLAG_UV2,			OFFSETOF_MEMBER( ovrDefaultVertexAttributeArrays, uv2 ),			SIZEOF_MEMBER( ovrDefaultVertexAttributeArrays, uv2[0] ),			VK_FORMAT_R32G32_SFLOAT,		1,	"vertexUv2" },
	{ OVR_VERTEX_ATTRIBUTE_FLAG_JOINT_INDICES,	OFFSETOF_MEMBER( ovrDefaultVertexAttributeArrays, jointIndices ),	SIZEOF_MEMBER( ovrDefaultVertexAttributeArrays, jointIndices[0] ),	VK_FORMAT_R32G32B32A32_SFLOAT,	1,	"vertexJointIndices" },
	{ OVR_VERTEX_ATTRIBUTE_FLAG_JOINT_WEIGHTS,	OFFSETOF_MEMBER( ovrDefaultVertexAttributeArrays, jointWeights ),	SIZEOF_MEMBER( ovrDefaultVertexAttributeArrays, jointWeights[0] ),	VK_FORMAT_R32G32B32A32_SFLOAT,	1,	"vertexJointWeights" },
	{ OVR_VERTEX_ATTRIBUTE_FLAG_TRANSFORM,		OFFSETOF_MEMBER( ovrDefaultVertexAttributeArrays, transform ),		SIZEOF_MEMBER( ovrDefaultVertexAttributeArrays, transform[0] ),		VK_FORMAT_R32G32B32A32_SFLOAT,	4,	"vertexTransform" },
	{ 0, 0, 0, (VkFormat) 0, 0, "" }
};
...
void ovrVkGeometry_Create( ovrVkContext * context, ovrVkGeometry * geometry,
...
void ovrVkGeometry_AddInstanceAttributes( ovrVkContext * context, ovrVkGeometry * geometry, const int numInstances, const int instanceAttribsFlags );
...
typedef enum
{
	OVR_PROGRAM_PARM_TYPE_TEXTURE_SAMPLED,					// texture plus sampler bound together		(GLSL: sampler*, isampler*, usampler*)
	OVR_PROGRAM_PARM_TYPE_TEXTURE_STORAGE,					// not sampled, direct read-write storage	(GLSL: image*, iimage*, uimage*)
	OVR_PROGRAM_PARM_TYPE_BUFFER_UNIFORM,					// read-only uniform buffer					(GLSL: uniform)
	...
	OVR_PROGRAM_PARM_TYPE_PUSH_CONSTANT_FLOAT,				// float									(GLSL: float)
	...
	OVR_PROGRAM_PARM_TYPE_PUSH_CONSTANT_FLOAT_MATRIX2X2,	// float[2][2]								(GLSL: mat2x2 or mat2)
	...
	OVR_PROGRAM_PARM_TYPE_PUSH_CONSTANT_FLOAT_MATRIX3X3,	// float[3][3]								(GLSL: mat3x3 or mat3)
	...
	OVR_PROGRAM_PARM_TYPE_PUSH_CONSTANT_FLOAT_MATRIX4X4,	// float[4][4]								(GLSL: mat4x4 or mat4)
...
typedef struct
{
	...
	int							offsetForIndex[MAX_PROGRAM_PARMS];	// push constant offsets into ovrVkProgramParmState::data based on ovrVkProgramParm::index
...
void ovrVkProgramParmLayout_Create( ovrVkContext * context, ovrVkProgramParmLayout * layout,
										const ovrVkProgramParm * parms, const int numParms );
...
bool ovrVkGraphicsProgram_Create( ovrVkContext * context, ovrVkGraphicsProgram * program,
										const void * vertexSourceData, const size_t vertexSourceSize,
										const void * fragmentSourceData, const size_t fragmentSourceSize,
										const ovrVkProgramParm * parms, const int numParms,
										const ovrVkVertexAttribute * vertexLayout, const int vertexAttribsFlags );
...
bool ovrVkGraphicsPipeline_Create( ovrVkContext * context, ovrVkGraphicsPipeline * pipeline, const ovrVkGraphicsPipelineParms * parms );
...
void ovrVkProgramParmState_SetParm( ovrVkProgramParmState * parmState, const ovrVkProgramParmLayout * parmLayout,
											const int index, const ovrVkProgramParmType parmType, const void * pointer );

const void * ovrVkProgramParmState_NewPushConstantData( const ovrVkProgramParmLayout * newLayout, const int newPushConstantIndex, const ovrVkProgramParmState * newParmState,
													const ovrVkProgramParmLayout * oldLayout, const int oldPushConstantIndex, const ovrVkProgramParmState * oldParmState,
													const bool force );

bool ovrVkProgramParmState_DescriptorsMatch( const ovrVkProgramParmLayout * layout1, const ovrVkProgramParmState * parmState1,
													const ovrVkProgramParmLayout * layout2, const ovrVkProgramParmState * parmState2 );
...
typedef struct
{
	...
	const ovrVkBuffer *				vertexBuffer;		// vertex buffer returned by ovrVkCommandBuffer_MapVertexAttributes
	const ovrVkBuffer *				instanceBuffer;		// instance buffer returned by ovrVkCommandBuffer_MapInstanceAttributes
...
void ovrVkGraphicsCommand_SetPipeline( ovrVkGraphicsCommand * command, const ovrVkGraphicsPipeline * pipeline );

void ovrVkGraphicsCommand_SetParmBufferUniform( ovrVkGraphicsCommand * command, const int index, const ovrVkBuffer * buffer );
...
void ovrVkPipelineResources_Create( ovrVkContext * context, ovrVkPipelineResources * resources,
										const ovrVkProgramParmLayout * parmLayout,
...
void ovrVkCommandBuffer_Create( ovrVkContext * context, ovrVkCommandBuffer * commandBuffer, const ovrVkCommandBufferType type, const int numBuffers );
...
void ovrVkCommandBuffer_ChangeTextureUsage( ovrVkCommandBuffer * commandBuffer, ovrVkTexture * texture, const ovrVkTextureUsage usage );

void ovrVkCommandBuffer_BeginFramebuffer( ovrVkCommandBuffer * commandBuffer, ovrVkFramebuffer * framebuffer, const int arrayLayer, const ovrVkTextureUsage usage );

void ovrVkCommandBuffer_EndFramebuffer( ovrVkCommandBuffer * commandBuffer, ovrVkFramebuffer * framebuffer, const int arrayLayer, const ovrVkTextureUsage usage );


void ovrVkCommandBuffer_BeginRenderPass( ovrVkCommandBuffer * commandBuffer, ovrVkRenderPass * renderPass, ovrVkFramebuffer * framebuffer, const ovrScreenRect * rect );

void ovrVkCommandBuffer_EndRenderPass( ovrVkCommandBuffer * commandBuffer, ovrVkRenderPass * renderPass );
...
void ovrVkCommandBuffer_UpdateProgramParms( ovrVkCommandBuffer * commandBuffer,
...
void ovrVkCommandBuffer_SubmitGraphicsCommand( ovrVkCommandBuffer * commandBuffer, const ovrVkGraphicsCommand * command );

ovrVkBuffer * ovrVkCommandBuffer_MapBuffer( ovrVkCommandBuffer * commandBuffer, ovrVkBuffer * buffer, void ** data );

void ovrVkCommandBuffer_UnmapBuffer( ovrVkCommandBuffer * commandBuffer, ovrVkBuffer * buffer, ovrVkBuffer * mappedBuffer, const ovrVkBufferUnmapType type );

ovrVkBuffer * ovrVkCommandBuffer_MapInstanceAttributes( ovrVkCommandBuffer * commandBuffer, ovrVkGeometry * geometry, ovrVkVertexAttributeArrays * attribs );

void ovrVkCommandBuffer_UnmapInstanceAttributes( ovrVkCommandBuffer * commandBuffer, ovrVkGeometry * geometry, ovrVkBuffer * mappedInstanceBuffer, const ovrVkBufferUnmapType type );
