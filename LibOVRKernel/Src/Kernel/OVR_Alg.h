...
inline uint8_t UpperBit(size_t val)
{
    ...
    if (val & 0xFFFF0000)
    {
        return (val & 0xFF000000) ? 
            static_cast<uint8_t>( UpperBitTable[(val >> 24)       ] + 24 ): 
            static_cast<uint8_t>( UpperBitTable[(val >> 16) & 0xFF] + 16 );
    }
    return (val & 0xFF00) ?
        static_cast<uint8_t>( UpperBitTable[(val >> 8) & 0xFF] + 8 ):
...
inline uint8_t LowerBit(size_t val)
{
    ...
    if (val & 0xFFFF)
    {
        return (val & 0xFF) ?
            ...
            static_cast<uint8_t>( LowerBitTable[(val >> 8) & 0xFF] + 8 );
    }
    return (val & 0xFF0000) ?
            static_cast<uint8_t>( LowerBitTable[(val >> 16) & 0xFF] + 16 ):
            static_cast<uint8_t>( LowerBitTable[(val >> 24) & 0xFF] + 24 );
