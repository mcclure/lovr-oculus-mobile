...
public:
    ...
    // The Root node is volatile to avoid issues with strict-aliasing optimizing out the
    // access after RemoveNode(), etc.
    bool IsEmpty()                   const { return Root.pNext == (const T*)(const B*)&Root; }
