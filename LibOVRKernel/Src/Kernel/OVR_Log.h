...
// These functions should normally be called using the OVR_DEBUG_LOG,
// OVR_DEBUG_LOG_TEXT and OVR_ASSERT_LOG methods unless you are absolutely
// sure you want them to be called in all build configurations.
