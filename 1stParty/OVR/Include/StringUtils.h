...
namespace StringUtils {
	...
	template<> inline size_t StringTo( short &          value, const char * str ) { char * endptr; value = (short) strtol( str, &endptr, 10 ); return size_t(endptr - str); }
	template<> inline size_t StringTo( unsigned short & value, const char * str ) { char * endptr; value = (unsigned short) strtoul( str, &endptr, 10 ); return size_t(endptr - str); }
	template<> inline size_t StringTo( int &            value, const char * str ) { char * endptr; value = strtol( str, &endptr, 10 ); return size_t(endptr - str); }
	template<> inline size_t StringTo( unsigned int &   value, const char * str ) { char * endptr; value = strtoul( str, &endptr, 10 ); return size_t(endptr - str); }
	template<> inline size_t StringTo( float &          value, const char * str ) { char * endptr; value = strtof( str, &endptr ); return size_t(endptr - str); }
	template<> inline size_t StringTo( double &         value, const char * str ) { char * endptr; value = strtod( str, &endptr ); return size_t(endptr - str); }
	...
	template <typename _type_> inline std::string ToString( const _type_ & value )
	{
		return std::string();
	}
	...
	template <> inline std::string ToString( const short & value )
	{
		return std::string( Va( " %hi", value ) );
	}
	template <> inline std::string ToString( const unsigned short & value )
	{
		return std::string( Va( " %uhi", value ) );
	}
	template <> inline std::string ToString( const int & value )
	{
		return std::string( Va( " %li", value ) );
	}
	template <> inline std::string ToString( const unsigned int & value )
	{
		return std::string( Va( " %uli", value ) );
	}
	template <> inline std::string ToString( const float & value )
	{
		return std::string( Va( " %f", value ) );
	}
	template <> inline std::string ToString( const double & value )
	{
		return std::string( Va( " %f", value ) );
	}

	template <> inline std::string ToString( const Vector2f & value )
	{
		return std::string( Va( "{ %f %f }", value.x, value.y ) );
	}
	template <> inline std::string ToString( const Vector2d & value )
	{
		return std::string( Va( "{ %f %f }", value.x, value.y ) );
	}
	template <> inline std::string ToString( const Vector2i & value )
	{
		return std::string( Va( "{ %d %d }", value.x, value.y ) );
	}

	template <> inline std::string ToString( const Vector3f & value )
	{
		return std::string( Va( "{ %f %f %f }", value.x, value.y, value.z ) );
	}
	template <> inline std::string ToString( const Vector3d & value )
	{
		return std::string( Va( "{ %f %f %f }", value.x, value.y, value.z ) );
	}
	template <> inline std::string ToString( const Vector3i & value )
	{
		return std::string( Va( "{ %d %d %d }", value.x, value.y, value.z ) );
	}

	template <> inline std::string ToString( const Vector4f & value )
	{
		return std::string( Va( "{ %f %f %f %f }", value.x, value.y, value.z, value.w ) );
	}
	template <> inline std::string ToString( const Vector4d & value )
	{
		return std::string( Va( "{ %f %f %f %f }", value.x, value.y, value.z, value.w ) );
	}
	template <> inline std::string ToString( const Vector4i & value )
	{
		return std::string( Va( "{ %d %d %d %d }", value.x, value.y, value.z, value.w ) );
	}

	template <> inline std::string ToString( const Matrix4f & value )
	{
		return std::string( Va( "{ %f %f %f %f %f %f %f %f %f %f %f %f %f %f %f %f }",
						   value.M[0][0],
						   value.M[0][1],
						   value.M[0][2],
						   value.M[0][3],
	...
	template <> inline std::string ToString( const Matrix4d & value )
	{
		return std::string( Va( "{ %f %f %f %f %f %f %f %f %f %f %f %f %f %f %f %f }",
						   value.M[0][0],
						   value.M[0][1],
	...
	template <> inline std::string ToString( const Quatf & value )
	{
		return std::string( Va( "{ %f %f %f %f }", value.x, value.y, value.z, value.w ) );
	}
	template <> inline std::string ToString( const Quatd & value )
	{
		return std::string( Va( "{ %f %f %f %f }", value.x, value.y, value.z, value.w ) );
	}

	template <> inline std::string ToString( const Planef & value )
	{
		return std::string( Va( "{ %f %f %f %f }", value.N.x, value.N.y, value.N.z, value.D ) );
	}
	template <> inline std::string ToString( const Planed & value )
	{
		return std::string( Va( "{ %f %f %f %f }", value.N.x, value.N.y, value.N.z, value.D ) );
	}

	template <> inline std::string ToString( const Bounds3f & value )
	{
	...
	template <> inline std::string ToString( const Bounds3d & value )
	{
		return std::string( Va( "{{ %f %f %f }{ %f %f %f }}",
						   value.b[0].x,
						   value.b[0].y,
